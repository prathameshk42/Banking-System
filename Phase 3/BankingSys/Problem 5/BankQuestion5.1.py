...
customerID = int(input("Enter customer ID of the business customer to create a new account"))
Acc = input("Enter account number")
acc_type = input("Enter account type(Checking/Savings)")
current_date = datetime.now().date()
sql_query1 = f"INSERT INTO {table_name1} (AccountNumber, LastAccessDate, AccountType) VALUES ('{Acc}','{current_date}', '{acc_type}')"
